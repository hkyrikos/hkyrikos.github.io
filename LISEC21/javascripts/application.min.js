...
// Zwischenspeicher id f�r dblClick
 ...
 * loadCatalogs()
 *
 * Diese Funktion l�dt die verf�gbaren Kataloge aus catalogs.xml und zeigt
 ...
 * setCatalog(id, name)
 *
 * L�dt den Katalog mit der �bergebenen ID
 *
 * @param id Die ID des Kataloges aus catalogs.xml. Diese ist dann der Dateiname des zu �ffnenden Kataloges.
...
function parseCatalog(xml) {
  ...
  $(xml).find("stk").each(function () {
      ...
      if (level > oldLevel) {
          ...
          // Level ist h�her - </ul> bis altes Level erreicht (z.B. von 1.1.1 auf 1.2)
